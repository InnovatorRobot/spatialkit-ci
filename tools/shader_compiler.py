...
class ShaderCompiler:
    ...
    def _compile_shader(self, source_path: Path, output_path: Path, 
                       shader_type: str, defines: Dict[str, str] = None) -> Tuple[bool, str]:
        """
    ...
    def compile_shader_pair(self, vert_name: str, frag_name: str, 
                           variant: str = "release", defines: Dict[str, str] = None) -> bool:
        """
...
def main():
    ...
    parser.add_argument('--source-dir', default='shaders/src',
                       help='Source shader directory')
    parser.add_argument('--output-dir', default='shaders/compiled',
